    ...
    <header className="border-b bg-white/95 backdrop:blur-sm fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 h-16 flex items-center  justify-between">
        ...
        <div className="flex items-center space-x-8">
          ...
          {/* Features Dropdown - Always show when authenticated */}
          {isAuthenticated && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center space-x-1 text-gray-600 hover:text-blue-600 h-auto p-0"
                >
              ...
              <DropdownMenuContent align="start">
                <DropdownMenuItem asChild>
                  <Link href="/features/medical-image-analysis" className="cursor-pointer">
                    Medical Image Analysis
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/features/voice-chat" className="cursor-pointer">
                    Voice Chat
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/features/chatbot" className="cursor-pointer">
                    Medical Chatbot
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/features/nearest-medical-centers" className="cursor-pointer">
